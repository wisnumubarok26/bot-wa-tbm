...
client.on('message', async (message) => {
    ...
    switch (command) {
        ...
        case '!tag':
            ...
            const participants = chat.participants; // Mengambil semua peserta dari grup
            membersToTag = participants.map(participant => participant.id._serialized); // Menyimpan semua anggota grup
            break;
        case '!hello':
